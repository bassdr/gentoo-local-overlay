...
IMG_REVISION="$(get_version_component_range 2)$(get_version_component_range 3)$(get_version_component_range 4)"
SRC_URI="http://build.anbox.io/android-images/${IMG_PATH}/android_amd64.img -> android_${IMG_REVISION}_amd64.img"
...
src_prepare() {
	...
	use elogind && \
		sed -i 's/libsystemd/libelogind/g'  CMakeLists.txt
