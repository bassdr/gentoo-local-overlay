...
inherit eutils java-pkg-2 java-ant-2 toolchain-funcs flag-o-matic fdo-mime gnome2-utils subversion

MY_P="${PN}-src-${PV}"
DESCRIPTION="TuxGuitar is a multitrack guitar tablature editor and player written in Java-SWT"
HOMEPAGE="http://www.tuxguitar.com.ar/"
ESVN_REPO_URI="svn://svn.code.sf.net/p/tuxguitar/code/trunk"
...
src_install() {
	...
	java-pkg_dolauncher ${PN} \
		--main org.herac.tuxguitar.app.TuxGuitar \
