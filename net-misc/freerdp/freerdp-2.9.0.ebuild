...
LICENSE="Apache-2.0"
SLOT="0/2"
IUSE="alsa cpu_flags_arm_neon cpu_flags_x86_sse2 cups debug doc faac faad +ffmpeg gsm gstreamer jpeg lame opencl openh264 pulseaudio server smartcard soxr systemd test usb vaapi wayland X xinerama xv"
RESTRICT="!test? ( test )"
