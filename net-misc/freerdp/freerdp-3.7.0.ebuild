...
LICENSE="Apache-2.0"
SLOT="3"
IUSE="aad alsa cpu_flags_arm_neon cpu_flags_x86_sse2 +client cups debug faac faad +ffmpeg +fuse gsm gstreamer +icu jpeg kerberos lame openh264 pulseaudio qt6 sdl server smartcard soxr systemd test usb vaapi valgrind wayland webview webengine X xinerama xv"
RESTRICT="!test? ( test )"
