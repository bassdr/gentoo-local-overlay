...
# $Header: /var/cvsroot/gentoo-x86/net-misc/rygel/rygel-0.24.2.ebuild,v 1.3 2015/03/15 13:32:15 pacho Exp $
...
#uuid >= 1.41.3 gio-2.0 >= 2.26 gmodule-2.0 libmediaart-2.0 >= 0.7.0
...
RDEPEND="
	...
	>=media-libs/libmediaart-0.7:1.0
