...
DEPEND=">=dev-lang/php-5.3.7[unicode]
...
src_prepare() {
  epatch "${FILESDIR}/kanboard-Makefile.patch" || die "Could not patch the Makefile"
}
...
src_install() {
        ...
        dodoc ${DOCS} doc/*.markdown

        # Clean everything not used at the site...
        rm -rf ${DOCS} scripts tests doc .gitignore || die
